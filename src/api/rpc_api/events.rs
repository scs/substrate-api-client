...
mod tests {
	...
	use ac_primitives::DefaultPlainConfig;
	use codec::{Decode, Encode};
	...
	fn retrieve_extrinsic_index_from_block_works() {
		...
		let xt_hash1 = <DefaultPlainConfig as Config>::Hasher::hash_of(&xt1.0);
		let xt_hash2 = <DefaultPlainConfig as Config>::Hasher::hash_of(&xt2.0);
		let xt_hash3 = <DefaultPlainConfig as Config>::Hasher::hash_of(&xt3.0);
