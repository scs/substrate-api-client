...
/// Order is (CheckVersion, CheckGenesis, Check::Era, CheckNonce, CheckWeight,
/// transactionPayment::ChargeTransactionPayment). This can be locked up in the System module.
/// Fields that are merely PhantomData are not encoded and are therefore omitted here.
...
/// Mirrors the currently used Extrinsic format (V3) from substrate. Has less traits and methods
/// though. The SingedExtra used does not need to implement SingedExtension here.
