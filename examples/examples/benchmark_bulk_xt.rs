...
use substrate_api_client::{
	ac_primitives::{DefaultAssetConfig, ExtrinsicSigner as GenericExtrinsicSigner, SignExtrinsic},
	rpc::JsonrpseeClient,
	Api, SubmitExtrinsic,
};
...
type ExtrinsicSigner = GenericExtrinsicSigner<DefaultAssetConfig>;
