...
use substrate_api_client::{
	ac_primitives::{DefaultAssetConfig, ExtrinsicSigner},
...
async fn main() {
	...
	api.set_signer(ExtrinsicSigner::<DefaultAssetConfig>::new(alice));
...
pub fn get_last_reward_received_for(
	...
	api: &substrate_api_client::Api<DefaultAssetConfig, JsonrpseeClient>,
) -> Option<u32> {
